...
class TestCLI:
    ...
    @patch(
        "src.application.use_cases.manage_stock.ManageStockUseCase.__init__",
        return_value=None,
    )
    ...
    @patch(
        "src.application.use_cases.manage_stock.ManageStockUseCase.fetch_stock_data"
    )  # Mock fetch_stock_data
    @patch(
        "src.application.use_cases.manage_stock.ManageStockUseCase.check_stock_exists"
    )  # Mock check_stock_exists
    def test_cli_fetch(
        self, mock_check_stock_exists, mock_fetch_stock_data, mock_get_session
    ):
    ...
    def test_cli_create_with_invalid_date(self, mock_create_stock, mock_get_session):
        ...
        # Ensure that stock creation was not called
    ...
    def test_cli_delete_stock_not_found(
        self, mock_init, mock_delete_stock, mock_get_session
    ):
